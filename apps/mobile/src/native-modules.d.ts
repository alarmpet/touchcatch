declare module 'react-native' {
  ...
  export const Image:ComponentType<NativeProps>,Modal:ComponentType<NativeProps>,Pressable:ComponentType<NativeProps>,ScrollView:ComponentType<NativeProps>,Text:ComponentType<NativeProps>,View:ComponentType<NativeProps>;
}
...
declare module 'react-native-safe-area-context' {import type {ComponentType} from 'react';export const SafeAreaView:ComponentType<{onLayout?:(event:{nativeEvent:{layout:{width:number;height:number}}})=>void;[key:string]:any}>}
