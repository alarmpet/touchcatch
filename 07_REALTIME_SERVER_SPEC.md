...
## 치팅 방지
- 초당 터치 최대 8회 <!-- REQ: OBS-001 -->
- 좌표 서버 검증 <!-- REQ: OBS-002 -->
- 같은 좌표 연타 탐지 <!-- REQ: OBS-003 -->
- 비정상 정답 반응속도 기록 <!-- REQ: OBS-004 -->
- 클라이언트 점수 무시 <!-- REQ: OBS-005 -->

## 연결 끊김
- 5초 이내 재접속 <!-- REQ: OBS-006 -->
- 15초 초과 시 기권 또는 무효 <!-- REQ: OBS-007 -->
- 서버 장애 시 양쪽 패배 금지 <!-- REQ: OBS-008 -->
