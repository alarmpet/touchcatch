...
const expected = {
  ...
  "POST /v1/pets/{id}/select": { request: "SelectPetRequest", statuses: ["200", "404", "409"], response: "SelectPetResponse", errors: ["NOT_OWNED", "IDEMPOTENCY_CONFLICT"] },
  ...
  "POST /v1/gacha/draw": { request: "GachaDrawRequest", statuses: ["200", "409"], response: "GachaDrawResponse", errors: ["IDEMPOTENCY_CONFLICT", "POLICY_MISMATCH", "INSUFFICIENT_FUNDS"] },
