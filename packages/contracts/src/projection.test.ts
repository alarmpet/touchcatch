import {expect,it} from 'vitest';import {projectMatchEvent,projectSnapshot} from './projection.js';import {matchSnapshotV1Schema,serverEventEnvelopeSchema} from './socket.schema.js';import type {MatchEvent,MatchStateV1} from './match.js';
