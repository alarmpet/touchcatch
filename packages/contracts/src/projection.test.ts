...
it('maps every domain event for owner, opponent, and public visibility without leaking private keys',()=>{
 ...
 const state={privateSolution:{schemaVersion:'1.0.0',contentRevisionId:'r',privateSolutionHash:'a'.repeat(64),finalChallenge:{canonicalAnswer:'cat',aliases:[],hintUnits:[],meaning:{prompt:'safe prompt',options:[{id:'a',label:'A'},{id:'b',label:'B'}],correctOptionId:'a'}},suddenDeath:{objectiveId:'sd',hitboxes:{imageA:{cx:0,cy:0,r:.1},imageB:{cx:0,cy:0,r:.1}}},differences:[{objectiveId:'d1',tier:'NORMAL',hitboxes:differenceCircles}],wordHunts:[]}} satisfies Pick<MatchStateV1,'privateSolution'>;
