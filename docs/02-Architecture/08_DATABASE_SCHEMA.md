---
title: "08_DATABASE_SCHEMA"
tags: [db, postgresql, supabase]
updated: 2026-07-30
status: "VERIFIED"
related: [[[07_REALTIME_SERVER_SPEC]], [[05_PET_COLLECTION_SYSTEM]]]
---
...
TypeScript `MatchPhase`/`MatchEndReason` SSOT와 `MATCH_DB_PROJECTION_V1`이 구현되어 있으며 cross-layer contract test가 SQL phase enum과 terminal winner/end-reason 조합을 domain projection에 대조한다. <!-- REQ: DATA-028 -->
